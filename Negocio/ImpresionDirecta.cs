...
namespace Negocio
{
    ...
    {
        private readonly static ImpresionDirecta instancia = new ImpresionDirecta();

        public static ImpresionDirecta Instancia
        {
            get { return instancia; }
        }
        public class CrearImpresion
        {
            StringBuilder linea = new StringBuilder();
            //private Image headerImage = null;
            //Creamos una variable para almacenar el numero maximo de caracteres que permitiremos en el ticket.
            int maxCar = 80, cortar;//Para una impresora ticketera solo debemos poner 40 Lineas. La variable cortar cortara el texto cuando rebase el limte.
            ...
            public void EncabezadoVenta()
            {
                ...
                //linea.AppendLine("ITEM                          |CANT  |PRECIO    "); Lo activamos en caso querramos cabecera fija: joel.
            }
            ...
            public void ImprimirDocumento(string impresora)
            {
        ...
        public class RawPrinterHelper
        {
            ...
            public static bool SendBytesToPrinter(string szPrinterName, IntPtr pBytes, Int32 dwCount)
            {
                ...
                di.pDocName = "Documento";//Este es el nombre con el que guarda el archivo en caso de no imprimir a la impresora fisica.
