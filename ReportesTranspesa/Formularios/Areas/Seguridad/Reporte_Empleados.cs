...
{
    public partial class Reporte_Empleados : MetroFramework.Forms.MetroForm
    {
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            dt = clsSeguridadBL.Instancia.GetDataFichaEmpleados(transpesa, bra, altra, amt, aduanas, estado);
            if (dt.Rows.Count > 0)
            {
                ...
                dtgvDataView.Columns["DNI"].Summary.Add(DevExpress.Data.SummaryItemType.Count, "DNI", "Total ={0}");
