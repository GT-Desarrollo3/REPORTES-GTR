...
{
    public partial class frmControlMttoMaquina : Form
    {
        public string CodigoMaquina;
        public decimal KMActual;
        public int xClick = 0, yClick = 0, idProcesoMtto;
        public int xClick2 = 0, yClick2 = 0;
        public int OpcionC = 0;
        DataTable dtPermisos = new DataTable();

        public frmControlMttoMaquina()
        {
            InitializeComponent();
        ...
        private void frmControlMttoMaquina_Load(object sender, EventArgs e)
        {
        ...
        public void ListarControlMtto()
        {
            ...
            {
                DataTable dtListaHistorial = clsMantenimientoBL.Instancia.ReportesApp_Mantenimiento_MttoPreventivo_ListarHistorialProcesosMaquinas(CodigoMaquina, Convert.ToInt32(cbxBuscar.SelectedValue));
                ...
                if (dtListaHistorial.Rows.Count > 0)
                {
                    ...
                    dgvControlMttoVista.Columns["MaquinaCodigo"].Visible = false;
            ...
            {
                DataTable dtListaMantenimiento = clsMantenimientoBL.Instancia.ReportesApp_Mantenimiento_MttoPreventivo_ListarControlMttoMaquinas(1, CodigoMaquina);
        ...
        private void cbHistorial_CheckedChanged(object sender, EventArgs e)
        {
            if (cbHistorial.Checked == true)
            {
                label1.Text = "HISTORIAL DE MANTENIMIENTO DE MÁQUINAS";
            ...
            if (cbHistorial.Checked == false)
            {
                label1.Text = "CONTROL DE MANTENIMIENTO DE MÁQUINAS";
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                dtAgregar = clsMantenimientoBL.Instancia.ReportesApp_Mantenimiento_MttoPreventivo_AgregarModificarControlMaquinas(CodigoMaquina, Convert.ToInt32(cbxAccesorio.SelectedValue), Convert.ToDecimal(txtKMCambio.Text),
        ...
        private void tAsignarRecursos_Click(object sender, EventArgs e)
        {
            ...
            frmAsignarRecursos.MaquinaCodigo = Convert.ToString(dgvControlMttoVista.GetRowCellValue(dgvControlMttoVista.FocusedRowHandle, "MaquinaCodigo"));
            ...
            frmAsignarRecursos.Opcion = 2;
            frmAsignarRecursos.dtgRecursos.SendToBack();
            frmAsignarRecursos.dtgRecursosMaquina.BringToFront();
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                dtAgregar = clsMantenimientoBL.Instancia.ReportesApp_Mantenimiento_MttoPreventivo_ManoObra_IngresarEliminarMOMaquinas(1, 0, idProcesoMtto, CodigoMaquina,
        ...
        private void eliminarToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("¿Desea eliminar este proceso de la tabla?", "CONTROL DE MANTENIMIENTO", MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
                ...
                string MaquinaCodigo = Convert.ToString(dgvControlMttoVista.GetRowCellValue(dgvControlMttoVista.FocusedRowHandle, "MaquinaCodigo"));

                DataTable dtRespuesta = new DataTable();
                string Respuesta;
                dtRespuesta = clsMantenimientoBL.Instancia.ReportesApp_Mantenimiento_MttoPreventivo_EliminarProcesosMaquinas(1, idProceso, MaquinaCodigo, 0.00m, 0.00m);
        ...
        private void eliminarHistorialToolStripItem_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("¿Desea eliminar este proceso del historial?", "CONTROL DE MANTENIMIENTO", MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
                ...
                DataTable dtRespuesta = new DataTable();
                string Respuesta;
                dtRespuesta = clsMantenimientoBL.Instancia.ReportesApp_Mantenimiento_MttoPreventivo_EliminarProcesosMaquinas(2, idProceso, MaquinaCodigo, Kilometraje, Intervalo);
                Respuesta = Convert.ToString(dtRespuesta.Rows[0]["exito"]);
                string NroRPTA = Respuesta.Substring(0, 1);
                if (NroRPTA == "0") { ListarControlMtto(); }
                else { MessageBox.Show(Respuesta, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error); }
        ...
        {
            DataTable dtListaMantenimiento2 = clsMantenimientoBL.Instancia.ReportesApp_Mantenimiento_MttoPreventivo_ListarControlMttoMaquinas(2, CodigoMaquina);

            if (dtListaMantenimiento2.Rows.Count > 0)
            {
                DataTable dtListaMantenimiento = clsMantenimientoBL.Instancia.ReportesApp_Mantenimiento_MttoPreventivo_ListarControlMttoMaquinas(2, CodigoMaquina);

                DataRow Espacio1, Espacio2, Placa, Marca, Modelo;
                ...
                if (filas.Length != 0)
                {
                    ...
                    if (MessageBox.Show("¿Desea actualizar las actividades de estos elementos?", "ACTUALIZAR ACTIVIDADES", MessageBoxButtons.YesNo) == DialogResult.Yes)
                    {
                        for (int i = 0; i < filas.Length; i++)
                        {
                            ...
                            dtAgregar = clsMantenimientoBL.Instancia.ReportesApp_Mantenimiento_MttoPreventivo_AgregarModificarControlMaquinas(MaquinaCodigo, idAccesorio, Convert.ToDecimal(txtKMC2.Text),
