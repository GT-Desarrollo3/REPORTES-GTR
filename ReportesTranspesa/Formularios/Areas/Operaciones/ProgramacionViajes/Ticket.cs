...
namespace impresora
{
    class Ticket
    {
        ...
        {
            line = line + "\x1B" + "m"; //Caracteres de corte. Estos comando varian segun el tipo de impresora
            line = line + "\x1B" + "d" + "\x09"; //Avanza 9 renglones, Tambien varian
        }
